...
public class KafkaConfig {
    ...
    public ProducerFactory<String, RawRecord> producerFactory() {
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, RawRecordSerdes.RawRecordSerializer.class);
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, CanonicalValueSerdes.CanonicalValueDeserializer.class);
